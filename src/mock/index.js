...
Mock.mock(/\/adpush\/jl\/campaign\/titlelist/, 'post', Advertising.campaignTitleList)
Mock.mock(/\/adpush\/jl\/campaign\/getList/, 'post', Advertising.campaignTableList)
Mock.mock(/\/adpush\/jl\/campaignedit\/getList/, 'post', Advertising.campaignTableList)
...
Mock.mock(/\/adpush\/jl\/ad\/titlelist/, 'post', Advertising.adTitleList)
Mock.mock(/\/adpush\/jl\/ad\/getList/, 'post', Advertising.adTableList)
Mock.mock(/\/adpush\/jl\/adedit\/getList/, 'post', Advertising.adTableList)
