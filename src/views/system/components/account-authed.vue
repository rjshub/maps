<template>
    <el-dialog :title="$t('lang.account_Connection_failed')"
        :visible.sync="dialogVisible"
        :close-on-click-modal='false'
        :close-on-press-escape='false'
        :before-close="handleClose"
        width="600px"
        custom-class="account-authed-container">
        <div class="connect-main">
            <span>{{$t('lang.account_Connection_failed_point')}}</span>
