...
let constReg = {
  ...
  // num: /^([1-9][0-9]*)(\.[0-9]{1,2})?$/, //整数、最多保留2位小数。
  num: /^([0-9]*)(\.[0-9]{1,2})?$/, //整数、最多保留2位小数。
...
export default function install(Vue, options) {
  ...
  Vue.datePickerShortcuts_2 = Vue.prototype.$datePickerShortcuts_2 = datePickerShortcuts_2;
  Vue.directive("focus", {
    // 当被绑定的元素插入到 DOM 中时……
