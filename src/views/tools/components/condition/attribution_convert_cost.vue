<template>
  <div class="cost_condition">
    <el-form
      key="attribution_convert_cost_form"
      :model="form"
      :rules="rules"
      ref="attribution_convert_cost_Form"
      label-width="0"
    ...
    >
      ...
      <div
        ...
        :key="`attribution_convert_cost_${index}`"
      >
        <!-- 输入框 -->
        <el-form-item
          label=""
...
import {
  ...
  attribution_convert_cost_campaignDataType as campaignDataType,
  attribution_convert_cost_adDataType as adDataType,
...
export default {
  ...
  methods: {
    ...
    costrange_change(param, update = true) {
      ...
      if (update) {
        this.refresh();
        this.$refs.attribution_convert_cost_Form.clearValidate();
      }
      ...
      if (param == 1) {
        ...
        if (this.form.compare == 6) {
          ...
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_1_6
          );
          this.form.costrange2 = this.form.costrange;
        } else {
          // 其他
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_1_X
          );
          this.form.costrange2 = "";
        }
      } else if (param == 2) {
        ...
        if (this.form.compare == 6) {
          //介于
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_2_6
          );
          this.form.costrange2 = this.form.costrange;
          ...
          // 其他
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_2_X
          );
          this.form.costrange2 = "";
          this.form.type2 = "";
        ...
        if (this.form.compare == 6) {
          //介于
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_3_6
          );
          this.form.costrange2 = this.form.costrange;
        } else {
          // 其他
          this.module_list = _.cloneDeep(
            formulaConfig.attribution_convert_cost_range_3_X
          );
          this.form.costrange2 = "";
        }
      }
      ...
      //   this.$refs.attribution_convert_cost_Form.validate()
    },
    compare_change(param) {
      this.refresh();
      this.$refs.attribution_convert_cost_Form.clearValidate();
      if (this.form.costrange == "") {
        this.$refs.attribution_convert_cost_Form.validate("costrange");
        this.$message({
    ...
    validator_form() {
      let state = true;
      this.$refs.attribution_convert_cost_Form.validate((valid) => {
        if (valid) {
          state = true;
    ...
    refresh() {
      ...
      this.form.attribution_convert_cost2 = ""; //选择介于的时候才出现
