<template>
    <div class="attribution_convert-condition">
        <el-form :model="form"
            :rules="rules"
            ref="elapsedTimeForm"
            label-width="0"
            ...
            <el-form-item label=""
                ...
                <el-input size="mini"
                    ...
                    v-model="form.attribution_convert">
                </el-input>
            </el-form-item>
            ...
            <div v-if="is_between"
                ...
                <span class="L">-</span>
                <el-form-item label=""
                    prop="attribution_convert2">
                    <el-input size="mini"
                        class="Number-int"
                        @change="validator_form"
                        v-model="form.attribution_convert2">
                    </el-input>
                </el-form-item>
            </div>
        </el-form>
