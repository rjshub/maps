<template>
  <div class="cost_condition">
    <el-form
      key="convert_cost_form"
      :model="form"
      :rules="rules"
      ref="convert_cost_Form"
      label-width="0"
    ...
    >
      ...
      <div
        ...
        :key="`convert_cost_${index}`"
      >
        <!-- 输入框 -->
        <el-form-item
          label=""
          v-if="module_item.type == 'input' && module_item.show"
          :prop="module_item.show? module_item.key:''"
...
import {
  ...
  convert_cost_campaignDataType as campaignDataType,
  convert_cost_adDataType as adDataType,
...
export default {
  ...
  methods: {
    ...
    costrange_change(param, update = true) {
      ...
      if (update) {
        this.refresh();
        this.$refs.convert_cost_Form.clearValidate();
      }
      ...
      if (param == 1) {
        ...
        if (this.form.compare == 6) {
          //介于
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_1_6);
          this.form.costrange2 = this.form.costrange;
        } else {
          // 其他
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_1_X);
          this.form.costrange2 = "";
        }
      } else if (param == 2) {
        // 成本
        ...
        if (this.form.compare == 6) {
          //介于
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_2_6);
          this.form.costrange2 = this.form.costrange;
          this.form.type2 = this.form.type;
          this.form.costrangetype2 = this.form.costrangetype;
        } else {
          // 其他
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_2_X);
          this.form.costrange2 = "";
          this.form.type2 = "";
        ...
        if (this.form.compare == 6) {
          //介于
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_3_6);
          this.form.costrange2 = this.form.costrange;
        } else {
          // 其他
          this.module_list = _.cloneDeep(formulaConfig.convert_cost_range_3_X);
          this.form.costrange2 = "";
        }
      }

      //   this.$refs.convert_cost_Form.validate()
    },
    compare_change(param) {
      this.refresh();
      this.$refs.convert_cost_Form.clearValidate();
      if (this.form.costrange == "") {
        this.$refs.convert_cost_Form.validate("costrange");
        this.$message({
        ...
        if (param == 6) {
          ...
          if (this.form.costrange == "1") {
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_1_6
            );
            this.form.costrange2 = this.form.costrange;
          } else if (this.form.costrange == "2") {
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_2_6
            );
            this.form.costrange2 = this.form.costrange;
            this.form.type2 = this.form.type;
            this.form.costrangetype2 = this.form.costrangetype;
            ...
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_3_6
            );
            this.form.costrange2 = this.form.costrange;
          }
        } else {
          ...
          if (this.form.costrange == "1") {
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_1_X
            );
            this.form.costrange2 = "";
          } else if (this.form.costrange == "2") {
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_2_X
            );
            this.form.costrange2 = "";
            this.form.type2 = "";
            this.form.costrangetype2 = "";
            ...
            this.module_list = _.cloneDeep(
              formulaConfig.convert_cost_range_3_X
            );
            this.form.costrange2 = "";
          }
        }
    ...
    validator_form() {
      let state = true;
      this.$refs.convert_cost_Form.validate((valid) => {
        if (valid) {
          state = true;
    ...
    refresh() {
      this.form.convert_cost = "";
      this.form.percent = ""; //50%
      this.form.convert_cost2 = ""; //选择介于的时候才出现
