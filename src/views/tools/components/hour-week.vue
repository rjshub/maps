        ...
        <div class="calendar">
            <table class="calendar-table"
                ...
                <thead class="calendar-head">
                    <tr>
                        <th rowspan="6"
                            class="week-td">{{this.$t('lang.public_week_time')}}</th>
                ...
                <tbody id="tableBody">
                    ...
                    <tr>
                        <td colspan="49"
                            class="td-table-tip">
                            <div class="clearfix">
                                <span class="pull-left tip-text">{{$t('lang.intelligent_rule_hour_week_point')}}</span>
                                <a @click="clear"
                                    class="pull-right">{{$t('lang.public_clear_all')}}</a>
                            </div>
                        </td>
                    </tr>
                    <tr>
...
export default {
  ...
  data() {
    return {
      ...
      weekDate: {
        1: this.$t("lang.public_Monday"),
        2: this.$t("lang.public_Tuesday"),
        3: this.$t("lang.public_Wednesday"),
        4: this.$t("lang.public_Thursday"),
        5: this.$t("lang.public_Friday"),
        6: this.$t("lang.public_Saturday"),
        7: this.$t("lang.public_Sunday"),
      },
      rowUnit: [], //每一个单元格
  ...
  methods: {
    init() {
      ...
      if (this.config.timeSection.length) {
        this.timeContent = this.config.timeContent;
        this.timeSection = this.config.timeSection;
        this.timeStr = this.config.timeStr;
        // setTimeout(() => {
